...
{
    my (@list) = ("Coach K is retiring.",
		  "John Scheyer is the new mens basketball coach.",
		  "Why is 210 now an alternative to 250?",
		  "Pointers make my head hurt!",
		  "This is a difficult assignment.",
		  "This is an easy phase.",
