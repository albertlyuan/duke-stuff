 ...
 */
listNode node6 = {155, 6, NULL};
listNode node5 = {77, 5, &node6};
listNode node4 = {475, 4, &node5};
listNode node3 = {217, 3, &node4};
listNode node2 = {504, 2, &node3};
listNode node1 = {907, 1, &node2};
