 ...
 */
listNode node6 = {915, 6, NULL};
listNode node5 = {484, 5, &node6};
listNode node4 = {440, 4, &node5};
listNode node3 = {747, 3, &node4};
listNode node2 = {397, 2, &node3};
listNode node1 = {681, 1, &node2};
