 ...
 */
listNode node6 = {782, 6, NULL};
listNode node5 = {378, 5, &node6};
listNode node4 = {856, 4, &node5};
listNode node3 = {625, 3, &node4};
listNode node2 = {941, 2, &node3};
listNode node1 = {153, 1, &node2};
