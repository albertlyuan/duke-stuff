 ...
 */
listNode node6 = {673, 6, NULL};
listNode node5 = {569, 5, &node6};
listNode node4 = {348, 4, &node5};
listNode node3 = {917, 3, &node4};
listNode node2 = {481, 2, &node3};
listNode node1 = {790, 1, &node2};
