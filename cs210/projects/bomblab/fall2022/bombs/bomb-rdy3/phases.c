 ...
 */
listNode node6 = {975, 6, NULL};
listNode node5 = {314, 5, &node6};
listNode node4 = {474, 4, &node5};
listNode node3 = {933, 3, &node4};
listNode node2 = {618, 2, &node3};
listNode node1 = {451, 1, &node2};
