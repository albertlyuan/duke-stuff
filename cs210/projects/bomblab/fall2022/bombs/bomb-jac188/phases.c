 ...
 */
listNode node6 = {420, 6, NULL};
listNode node5 = {575, 5, &node6};
listNode node4 = {913, 4, &node5};
listNode node3 = {276, 3, &node4};
listNode node2 = {329, 2, &node3};
listNode node1 = {839, 1, &node2};
