 ...
 */
listNode node6 = {466, 6, NULL};
listNode node5 = {976, 5, &node6};
listNode node4 = {881, 4, &node5};
listNode node3 = {547, 3, &node4};
listNode node2 = {156, 2, &node3};
listNode node1 = {520, 1, &node2};
