 ...
 */
listNode node6 = {658, 6, NULL};
listNode node5 = {394, 5, &node6};
listNode node4 = {882, 4, &node5};
listNode node3 = {585, 3, &node4};
listNode node2 = {491, 2, &node3};
listNode node1 = {355, 1, &node2};
