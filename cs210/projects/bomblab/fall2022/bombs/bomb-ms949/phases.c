 ...
 */
listNode node6 = {191, 6, NULL};
listNode node5 = {225, 5, &node6};
listNode node4 = {745, 4, &node5};
listNode node3 = {55, 3, &node4};
listNode node2 = {981, 2, &node3};
listNode node1 = {591, 1, &node2};
