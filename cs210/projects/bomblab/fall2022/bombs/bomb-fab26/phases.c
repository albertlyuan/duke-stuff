 ...
 */
listNode node6 = {903, 6, NULL};
listNode node5 = {935, 5, &node6};
listNode node4 = {345, 4, &node5};
listNode node3 = {912, 3, &node4};
listNode node2 = {119, 2, &node3};
listNode node1 = {398, 1, &node2};
