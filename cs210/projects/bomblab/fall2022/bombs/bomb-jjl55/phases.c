 ...
 */
listNode node6 = {396, 6, NULL};
listNode node5 = {725, 5, &node6};
listNode node4 = {432, 4, &node5};
listNode node3 = {417, 3, &node4};
listNode node2 = {917, 2, &node3};
listNode node1 = {448, 1, &node2};
