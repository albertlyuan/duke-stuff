 ...
 */
listNode node6 = {289, 6, NULL};
listNode node5 = {986, 5, &node6};
listNode node4 = {405, 4, &node5};
listNode node3 = {544, 3, &node4};
listNode node2 = {155, 2, &node3};
listNode node1 = {984, 1, &node2};
