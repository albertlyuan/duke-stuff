 ...
 */
listNode node6 = {895, 6, NULL};
listNode node5 = {520, 5, &node6};
listNode node4 = {535, 4, &node5};
listNode node3 = {688, 3, &node4};
listNode node2 = {188, 2, &node3};
listNode node1 = {692, 1, &node2};
