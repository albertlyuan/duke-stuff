 ...
 */
listNode node6 = {88, 6, NULL};
listNode node5 = {887, 5, &node6};
listNode node4 = {242, 4, &node5};
listNode node3 = {715, 3, &node4};
listNode node2 = {550, 2, &node3};
listNode node1 = {942, 1, &node2};
