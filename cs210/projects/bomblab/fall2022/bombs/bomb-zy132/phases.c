 ...
 */
listNode node6 = {765, 6, NULL};
listNode node5 = {751, 5, &node6};
listNode node4 = {876, 4, &node5};
listNode node3 = {430, 3, &node4};
listNode node2 = {247, 2, &node3};
listNode node1 = {642, 1, &node2};
