 ...
 */
listNode node6 = {745, 6, NULL};
listNode node5 = {309, 5, &node6};
listNode node4 = {397, 4, &node5};
listNode node3 = {987, 3, &node4};
listNode node2 = {582, 2, &node3};
listNode node1 = {440, 1, &node2};
