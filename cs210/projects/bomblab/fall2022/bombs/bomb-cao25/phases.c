 ...
 */
listNode node6 = {629, 6, NULL};
listNode node5 = {623, 5, &node6};
listNode node4 = {225, 4, &node5};
listNode node3 = {386, 3, &node4};
listNode node2 = {739, 2, &node3};
listNode node1 = {576, 1, &node2};
