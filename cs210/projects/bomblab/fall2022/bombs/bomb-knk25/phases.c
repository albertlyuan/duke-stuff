 ...
 */
listNode node6 = {751, 6, NULL};
listNode node5 = {392, 5, &node6};
listNode node4 = {395, 4, &node5};
listNode node3 = {937, 3, &node4};
listNode node2 = {96, 2, &node3};
listNode node1 = {844, 1, &node2};
