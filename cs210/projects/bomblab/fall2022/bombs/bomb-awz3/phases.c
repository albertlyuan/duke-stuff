 ...
 */
listNode node6 = {415, 6, NULL};
listNode node5 = {617, 5, &node6};
listNode node4 = {726, 4, &node5};
listNode node3 = {310, 3, &node4};
listNode node2 = {568, 2, &node3};
listNode node1 = {128, 1, &node2};
