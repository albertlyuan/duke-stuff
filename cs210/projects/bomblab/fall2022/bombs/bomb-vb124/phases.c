 ...
 */
listNode node6 = {931, 6, NULL};
listNode node5 = {463, 5, &node6};
listNode node4 = {653, 4, &node5};
listNode node3 = {285, 3, &node4};
listNode node2 = {521, 2, &node3};
listNode node1 = {323, 1, &node2};
