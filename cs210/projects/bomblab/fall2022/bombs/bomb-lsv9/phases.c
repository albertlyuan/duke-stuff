 ...
 */
listNode node6 = {911, 6, NULL};
listNode node5 = {311, 5, &node6};
listNode node4 = {524, 4, &node5};
listNode node3 = {840, 3, &node4};
listNode node2 = {478, 2, &node3};
listNode node1 = {849, 1, &node2};
