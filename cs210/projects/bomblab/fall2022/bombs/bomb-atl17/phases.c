 ...
 */
listNode node6 = {337, 6, NULL};
listNode node5 = {124, 5, &node6};
listNode node4 = {825, 4, &node5};
listNode node3 = {187, 3, &node4};
listNode node2 = {148, 2, &node3};
listNode node1 = {968, 1, &node2};
