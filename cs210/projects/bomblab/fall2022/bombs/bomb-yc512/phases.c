 ...
 */
listNode node6 = {886, 6, NULL};
listNode node5 = {345, 5, &node6};
listNode node4 = {755, 4, &node5};
listNode node3 = {610, 3, &node4};
listNode node2 = {408, 2, &node3};
listNode node1 = {743, 1, &node2};
