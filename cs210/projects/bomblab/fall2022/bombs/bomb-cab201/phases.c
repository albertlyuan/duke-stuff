 ...
 */
listNode node6 = {447, 6, NULL};
listNode node5 = {405, 5, &node6};
listNode node4 = {81, 4, &node5};
listNode node3 = {165, 3, &node4};
listNode node2 = {573, 2, &node3};
listNode node1 = {330, 1, &node2};
