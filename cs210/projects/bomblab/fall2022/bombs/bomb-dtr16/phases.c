 ...
 */
listNode node6 = {127, 6, NULL};
listNode node5 = {867, 5, &node6};
listNode node4 = {180, 4, &node5};
listNode node3 = {493, 3, &node4};
listNode node2 = {351, 2, &node3};
listNode node1 = {459, 1, &node2};
