 ...
 */
listNode node6 = {331, 6, NULL};
listNode node5 = {247, 5, &node6};
listNode node4 = {234, 4, &node5};
listNode node3 = {955, 3, &node4};
listNode node2 = {650, 2, &node3};
listNode node1 = {164, 1, &node2};
