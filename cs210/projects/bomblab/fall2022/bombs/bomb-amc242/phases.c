 ...
 */
listNode node6 = {360, 6, NULL};
listNode node5 = {53, 5, &node6};
listNode node4 = {624, 4, &node5};
listNode node3 = {777, 3, &node4};
listNode node2 = {180, 2, &node3};
listNode node1 = {53, 1, &node2};
