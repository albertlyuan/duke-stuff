 ...
 */
listNode node6 = {140, 6, NULL};
listNode node5 = {551, 5, &node6};
listNode node4 = {806, 4, &node5};
listNode node3 = {359, 3, &node4};
listNode node2 = {740, 2, &node3};
listNode node1 = {607, 1, &node2};
