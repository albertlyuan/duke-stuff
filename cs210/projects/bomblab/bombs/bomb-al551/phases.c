 ...
 */
listNode node6 = {384, 6, NULL};
listNode node5 = {744, 5, &node6};
listNode node4 = {357, 4, &node5};
listNode node3 = {879, 3, &node4};
listNode node2 = {756, 2, &node3};
listNode node1 = {335, 1, &node2};
