 ...
 */
listNode node6 = {987, 6, NULL};
listNode node5 = {308, 5, &node6};
listNode node4 = {102, 4, &node5};
listNode node3 = {331, 3, &node4};
listNode node2 = {337, 2, &node3};
listNode node1 = {698, 1, &node2};
