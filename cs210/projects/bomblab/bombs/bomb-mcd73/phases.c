 ...
 */
listNode node6 = {61, 6, NULL};
listNode node5 = {350, 5, &node6};
listNode node4 = {658, 4, &node5};
listNode node3 = {974, 3, &node4};
listNode node2 = {283, 2, &node3};
listNode node1 = {916, 1, &node2};
