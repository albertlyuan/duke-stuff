 ...
 */
listNode node6 = {907, 6, NULL};
listNode node5 = {775, 5, &node6};
listNode node4 = {284, 4, &node5};
listNode node3 = {666, 3, &node4};
listNode node2 = {230, 2, &node3};
listNode node1 = {633, 1, &node2};
