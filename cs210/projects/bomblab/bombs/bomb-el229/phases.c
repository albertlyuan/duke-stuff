 ...
 */
listNode node6 = {111, 6, NULL};
listNode node5 = {209, 5, &node6};
listNode node4 = {563, 4, &node5};
listNode node3 = {638, 3, &node4};
listNode node2 = {645, 2, &node3};
listNode node1 = {913, 1, &node2};
