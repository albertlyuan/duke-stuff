 ...
 */
listNode node6 = {370, 6, NULL};
listNode node5 = {68, 5, &node6};
listNode node4 = {344, 4, &node5};
listNode node3 = {915, 3, &node4};
listNode node2 = {702, 2, &node3};
listNode node1 = {446, 1, &node2};
