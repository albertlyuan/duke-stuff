 ...
 */
listNode node6 = {531, 6, NULL};
listNode node5 = {897, 5, &node6};
listNode node4 = {204, 4, &node5};
listNode node3 = {550, 3, &node4};
listNode node2 = {503, 2, &node3};
listNode node1 = {540, 1, &node2};
