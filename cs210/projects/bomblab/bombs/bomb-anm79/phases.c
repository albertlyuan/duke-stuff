 ...
 */
listNode node6 = {390, 6, NULL};
listNode node5 = {930, 5, &node6};
listNode node4 = {353, 4, &node5};
listNode node3 = {662, 3, &node4};
listNode node2 = {528, 2, &node3};
listNode node1 = {313, 1, &node2};
