 ...
 */
listNode node6 = {589, 6, NULL};
listNode node5 = {943, 5, &node6};
listNode node4 = {71, 4, &node5};
listNode node3 = {660, 3, &node4};
listNode node2 = {873, 2, &node3};
listNode node1 = {478, 1, &node2};
