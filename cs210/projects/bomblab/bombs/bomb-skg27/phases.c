 ...
 */
listNode node6 = {573, 6, NULL};
listNode node5 = {893, 5, &node6};
listNode node4 = {928, 4, &node5};
listNode node3 = {73, 3, &node4};
listNode node2 = {558, 2, &node3};
listNode node1 = {491, 1, &node2};
