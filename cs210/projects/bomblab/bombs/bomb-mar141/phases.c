 ...
 */
listNode node6 = {601, 6, NULL};
listNode node5 = {52, 5, &node6};
listNode node4 = {413, 4, &node5};
listNode node3 = {62, 3, &node4};
listNode node2 = {72, 2, &node3};
listNode node1 = {467, 1, &node2};
